...
# ── MD 读 + frontmatter 切 ──────────────────────────────────────
# 0.11.0-alpha.1:slugify / _stringify_dates / split_frontmatter 已搬到 schema.py
# 这里通过顶部 import re-export · 保留 read_md 因为它涉及 fs IO(留 build.py)
...
# 0.11.0-alpha.1:frontmatter governance / Issue / validate_meta /
#   extract_subtasks_from_body / extract_docs_from_body 全部搬到 schema.py
#   (plan-eng-review 1A · build.py 减肥)· 见顶部 import
