...
subtasks:
  ...
  - id: M06-b8a485
    title: "渲染左侧树形导航 · 项目根 + ~/.claude/{plans,projects} 全扫一遍按目录展开"
    status: done
    code: ["docs_cockpit/templates/browse.html.tmpl", "docs_cockpit/browse.py"]


  - id: M06-5381fe
    title: "把通用 markdown 渲染器接入 · 支持 GFM 表格跟代码块"
    status: done
    code: "docs_cockpit/templates/browse.html.tmpl"


  - id: M06-e6242e
    title: "树形导航支持关键字过滤 · 用户搜文件名快速跳转"
    status: done
    code: "docs_cockpit/templates/browse.html.tmpl"


  - id: M06-9cc315
    title: "file:// 协议兼容 · MD 内容 build 阶段内联进 HTML · 不依赖 fetch"
    status: done
    code: ["docs_cockpit/browse.py", "docs_cockpit/templates/browse.html.tmpl"]
