...
subtasks:
  ...
  - id: M11-5b8802
    title: "author skill §3.1.2 加 code anchor 字段表 + §3.1.3 加 doc anchor 字段表"
    status: done
    code: "skills/docs-cockpit-author/SKILL.md"


  - id: M11-cc7fd7
    title: "tests/unit/test_paths.py · TestSchemaConsistency_v0_14_3 · 5 测试 cover 新字段 + 老字段不变"
    status: done
  ...
  - id: M11-5174db
    title: "CHANGELOG 加 schema-additions section(走 v0.14.3 patch · stability contract reaffirm)"
    status: done
