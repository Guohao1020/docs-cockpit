你正在 **refine** docs-cockpit module **M12 · Parser robustness · subtask section heading**(sprint 0.13)。
...
subtasks:
  ...
  - id: M12-b5ed6c
    title: "`_SUBTASK_SECTION_RE` 放宽接受 § / 三级 heading / tab"
    status: done
    code: "docs_cockpit/schema.py:152-160"


  - id: M12-181bf0
    title: "`_DOCS_SECTION_RE` 对称放宽"
    status: done
    code: "docs_cockpit/schema.py:161-168"


  - id: M12-1227af
    title: "tests/unit/test_schema.py · TestSectionRegex_v0_14_3 · 22+ fixture 全 cover positive + negative"
    status: done
    code: "tests/unit/test_schema.py"


  - id: M12-a6463b
    title: "dogfood 验证 · M08/M09/M10 改回 `## §N · 待办` · parser 仍 work(7/7/6 subtasks parsed)"
    status: done
    code: ["docs/spec/module/M08-apply-patch.md", "docs/spec/module/M09-sync-status.md", "docs/spec/module/M10-llm-doc-optimizer.md"]


  - id: M12-cfec2c
    title: "author skill §3.1 Form C 加「接受的 heading 形式」表"
    status: done
...
### schema._SUBTASK_SECTION_RE

`docs_cockpit/schema.py`
