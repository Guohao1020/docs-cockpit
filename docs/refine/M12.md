...
subtasks:
  ...
  - id: M12-64c000
    title: "放宽子任务段落的 heading regex · 接受 § 前缀 / 三级 heading / tab 空格"
    status: done
    code: "docs_cockpit/schema.py:152-160"


  - id: M12-7039f3
    title: "关联文档段落的 heading regex 同步放宽 · 命名对称"
    status: done
    code: "docs_cockpit/schema.py:161-168"


  - id: M12-392315
    title: "单元测试覆盖 22+ heading fixture · positive 跟 negative 都验"
    status: done
    code: "tests/unit/test_schema.py"


  - id: M12-2c2832
    title: "dogfood 验证 · 三个老 module 改回带 § 的 heading · parser 仍能完整解析所有子任务"
    status: done
    code: ["docs/spec/module/M08-apply-patch.md", "docs/spec/module/M09-sync-status.md", "docs/spec/module/M10-llm-doc-optimizer.md"]


  - id: M12-d1bd59
    title: "author skill 加「接受的 heading 形式」表 · 让用户知道哪些写法 parser 认"
    status: done
