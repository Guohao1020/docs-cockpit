...
subtasks:
  ...
  - id: M04-8edc07
    title: "写齐 frontmatter schema 完整规范 · 给所有后续模块当真相源"
    status: done
    code: "skills/docs-cockpit-author/SKILL.md:34-296"
    docs: "skills/docs-cockpit-author/SKILL.md#section-1-to-8"

  - id: M04-a30b7b
    title: "把 docs 与 subtasks 的边界讲清 · 给用户写文档时不再混淆"
    status: done
    code: "skills/docs-cockpit-author/SKILL.md:145-295"
    docs: "skills/docs-cockpit-author/SKILL.md#\u00a73"

  - id: M04-752671
    title: "锁定五种文档类型的命名规则 · 让 AI 写新文档时落点统一"
    status: done
    code: "skills/docs-cockpit-author/SKILL.md:297-311"
    docs: "skills/docs-cockpit-author/SKILL.md#\u00a74"

  - id: M04-fe43ce
    title: "校验器输出格式标准化 · 每条问题都能追溯到规范段落"
    status: done
    code: "docs_cockpit/schema.py:478-541"
    docs: "skills/docs-cockpit-author/SKILL.md#\u00a75"

  - id: M04-5c19d5
    title: "把 subtask 升为对象 schema · 让每条子任务能独立追踪"
    status: done
  ...
  - id: M04-4d1c66
    title: "给 subtask id 加稳定生成算法 · 重命名 title 时讲清 trade-off"
    status: done
    code: "docs_cockpit/schema.py:398-419"
    docs: "skills/docs-cockpit-author/SKILL.md:208-230"

  - id: M04-438a91
    title: "加 prompt template 规范章节 · 四种内置 template 各自适用场景写清"
    status: done
    code: "docs_cockpit/prompt.py:130-237"
    docs: "skills/docs-cockpit-author/SKILL.md:437-461"

  - id: M04-ece706
    title: "给 prompt context 变量定 stability contract · 让自定义 template 升级时不破"
    status: done
    code: "docs_cockpit/prompt.py:239-310"
    docs: "skills/docs-cockpit-author/SKILL.md:462-481"

  - id: M04-1c2814
    title: "body 内联 anchor 语法文档化 · 让 AI 在 checklist 里就能挂代码跟文档锚"
    status: done
    code: "docs_cockpit/schema.py:185-223"
    docs: "skills/docs-cockpit-author/SKILL.md:181-207"
