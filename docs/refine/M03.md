...
subtasks:
  ...
  - id: M03-f26708
    title: "v0.11 plugin.json + marketplace.json + __init__.py + CHANGELOG 4 文件 version bump"
    status: done
  ...
  - id: M03-3c1f8b
    title: "v0.12 候选 · MCP server · 让 Claude 直连消费 cockpit prompt(替代 copy-paste · **moved to M07-mcp-server.md** · sprint 0.12 已 ship)"
    status: done
