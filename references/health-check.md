...
**场景适配 · Greenfield（空地建卡 · build 0→1）**：「项目还没有既有关联」**不是跳过体检的理由**——体检对象就是本次新建的卡/文档本身：①（新卡 frontmatter 合规）与 ④（每张新卡有真实上游支撑——ROADMAP / PRD / plan 链接 · 孤儿风险）必跑，外加新文档 desc/scope 措辞质量过目；无锚可验时 ②③ 整科标 **N/A**（N/A 是 verdict，不是跳过整次体检的理由——与 ⑥ 科「没工具标 N/A」同款机制，N/A 科不计入总评）。**基线 HEALTH.md 必写**：干净的新看板诚实给 A，基线是下次 rebuild 复查 diff 的起点——空地建卡跳过体检 = 下次复查无基线可比。
